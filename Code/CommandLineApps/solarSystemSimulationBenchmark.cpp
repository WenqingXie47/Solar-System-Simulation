...
int main()
{
    ...
    double simulationTime = 100; // 100 year
    ...
    for (int i=0 ; i<8; i++){
        ...
        double kineticEnergy_begin = simulator.calculateKineticEnergy();
        double potentialEnergy_begin =simulator.calculatePotentialEnergy();
        ...
        double kineticEnergy_end = simulator.calculateKineticEnergy();
        double potentialEnergy_end =simulator.calculatePotentialEnergy();
